				...
				<div class="metabox-holder columns-2" id="dashboard-widgets">
					...
					<div class="postbox-container">
						<div style="min-height: 1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
							...
							<div class="postbox " >
								<h2 class="hndle">
									<img class="wp_automatic_box_icon" src="<?php echo plugins_url('images/it.png',__FILE__)?>"><span> Instagram settings</span>
								</h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									<!--start container-->
							...
							<div class="postbox " id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										...
										<div class="description">Check <a href="http://valvepress.com/how-to-get-soundcloud-client_id-to-auto-post-from-soundcloud-to-wordpress/" target="_blank">this tutorial</a> on how to get it or use this key "376f225bf427445fc4bfb6b99b72e0bf" which is soundCloud master key. </div>
									</div>
							...
							<div class="postbox " id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										<label>App Id</label> <input value="<?php echo get_option( 'wp_automatic_mt_id' ) ?>" name="wp_automatic_mt_id" type="text">
										<div class="description">Check <a href="http://valvepress.com/how-to-get-microsoft-translator-app-id-and-secret/" target="_blank">this tutorial</a> on how to get your ID and secret </div>
									</div>
									
									
									<div class="field f_100 ">
										<label>App Secret</label> <input value="<?php echo get_option( 'wp_automatic_mt_secret' ) ?>" name="wp_automatic_mt_secret" type="text">
