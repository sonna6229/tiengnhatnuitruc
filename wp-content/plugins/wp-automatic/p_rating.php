...
function wp_automatic_rating_notice() {
	...
	if(trim($wp_automatic_rating) == ''){
		...
		if($count > 10 ){
		    ...
		    <div class="updated">
		        <p><?php echo 'Do you mind helping (<a href="http://deandev.com/">ValvePress</a>) by rating  "Wordpress automatic plugin" ? your high rating will <strong>help us improve</strong> the plugin <a style="text-decoration: underline;" href="http://codecanyon.net/downloads">Rate Now »</a> <a  style="float:right"  href="'.$uri.'">(x) </a> '; ?></p>
		    </div>
		    <?php
