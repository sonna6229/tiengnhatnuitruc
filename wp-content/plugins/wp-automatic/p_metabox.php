...
<div class="panes">
	...
	<input type="hidden" value="<?php echo $post_id ?>" id="wp_automatic_post_id" />
		...
		<div id="field-camp_type-container" class="field f_100" style="margin-top:10px" >
          ...
          <div  id="field111-container" class="field typepart Articles ArticlesBase Amazon Clickbank Youtube Vimeo Flicker  eBay f_100 Pinterest Instagram Twitter SoundCloud Itunes Envato" style="display:none;" >
               <label for="field111">
		...
		<!-- Feed part -->
						               		...
						               		<div class="option clearfix">
									            ...
									            <div id="wp_auatomatic_part_to_field" class="field f_100">
									           		 ...
									           		 <div class="description">
											             ...
											             <textarea name="cg_part_to_field" ><?php  echo htmlentities(@$camp_general['cg_part_to_field'])   ?></textarea>
							                ...
							                <div class="option clearfix">
								             ...
								             <div class="option clearfix">
								              ...
								              <div class="option clearfix">
								                    ...
								                    <span class="option-title">
															Don't strip script tags (not recommended)
								                    </span>
								                    <br>
								             </div>
		 ...
		 <!-- amazon part -->
          ...
          <div id="field1zz-container" class="field f_100 typepart Amazon"  style="display:none">
               ...
               <select name="camp_amazon_region" id="field1zzg">
							 ...
							 <option  value="co.jp"  <?php @wp_automatic_opt_selected('co.jp',$camp_amazon_region) ?> >co.jp</option>
							 <option  value="in"  <?php @wp_automatic_opt_selected('in',$camp_amazon_region) ?> >in</option>
							 <option  value="com.br"  <?php @wp_automatic_opt_selected('com.br',$camp_amazon_region) ?> >com.br</option>
							  <option  value="com.mx"  <?php @wp_automatic_opt_selected('com.mx',$camp_amazon_region) ?> >com.mx</option>
		 ...
		 <div id="yt_date_div" class="typepart Youtube Feeds Instagram Facebook Twitter SoundCloud field f_100">
               <div class="option clearfix">
		...
		<div   class="field f_100" >
		 ...
		 <div class="option clearfix">
		            ...
		            <div id="keyword_to_cat" class="field f_100">
		               ...
		               <textarea name="cg_keyword_cat" ><?php echo htmlentities($camp_general['cg_keyword_cat'] )  ?></textarea>
		            	<div class="description">
		...
		<div class="field f_100">
		 ...
		 <div class="option clearfix">
		            ...
		            <div id="keyword_to_tag" class="field f_100">
		               ...
		               <textarea name="cg_keyword_tag" ><?php echo htmlentities($camp_general['cg_keyword_tag'] )  ?></textarea>
		            	<div class="description">
